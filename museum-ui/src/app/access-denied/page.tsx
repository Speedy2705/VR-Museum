    ...
    <>
      ...
      <main className="grid min-h-[60vh] place-items-center bg-cream px-6 py-20 text-center text-ink">
        <div className="max-w-xl">
          <p className="text-[10px] tracking-label uppercase text-stone">Role-restricted area</p>
          ...
          <Link href="/marketplace" className="mt-8 inline-block bg-ink px-6 py-3 text-[10px] tracking-label uppercase text-white">
