    ...
    <>
      ...
      <main className="min-h-[65vh] bg-cream px-6 py-20 text-ink">
        <div className="mx-auto max-w-lg">
          <p className="text-[10px] tracking-label uppercase text-stone">One last step</p>
          ...
          <form onSubmit={submit} className="mt-10">
            <label htmlFor="profile-role" className="text-[10px] tracking-label uppercase text-stone">
              Role
            </label>
            <select
              id="profile-role"
              ...
              className="mt-3 w-full border-b border-line bg-transparent py-3 text-sm focus:border-ink focus:outline-none"
            >
            ...
            <button
              ...
              className="mt-8 w-full bg-ink py-3.5 text-[11px] tracking-label uppercase text-white disabled:cursor-not-allowed disabled:opacity-50"
            >
